...
from triangles.task3_triangles.traingle import Triangle
from triangles.task3_triangles.validation_triangles import \
...
def main():
    ...
    triangle.sort_all_triangles(all_triangles)
